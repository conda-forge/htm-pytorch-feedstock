...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/htm-pytorch-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14123&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/htm-pytorch-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `htm-pytorch` can be installed with:

```
conda install htm-pytorch
```

It is possible to list all of the versions of `htm-pytorch` available on your platform with:
